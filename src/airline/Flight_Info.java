...
public class Flight_Info extends JFrame{
	...
	FlightDetails.setFont(new Font("Courier", Font.BOLD, 31));
	...
	btnShow.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent ae) {
                ...
                try {
                    conn c = new conn();
                    String str = "select f_code,f_name,source,destination,capacity,class_code,class_name from flight ,sector where f_code = '"+code+"'";
