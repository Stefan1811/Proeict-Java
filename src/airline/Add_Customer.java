...
public class Add_Customer extends JFrame{
	...
	JTextField textField,textField_1,textField_2,textField_3,textField_4,textField_5,textField_6;
        ...
        public Add_Customer(){
            ...
            Passportno.setFont(new Font("Courier", Font.BOLD, 17));
            ...
            JLabel Pnrno = new JLabel("PNR Number");
            Pnrno.setFont(new Font("Courier", Font.BOLD, 17));
            ...
            Address.setFont(new Font("Courier", Font.BOLD, 17));
            ...
            Nationality.setFont(new Font("Courier", Font.BOLD, 17));
            ...
            Name.setFont(new Font("Courier", Font.BOLD, 17));
            ...
            Gender.setFont(new Font("Courier", Font.BOLD, 17));
            ...
            Phno.setFont(new Font("Courier", Font.BOLD, 17));
            ...
            AddPassengers.setFont(new Font("Courier", Font.BOLD, 31));
            AddPassengers.setBounds(420, 24, 442, 35);
            add(AddPassengers);
			
    
            JLabel Flightcode = new JLabel("Flight Code");
            Flightcode.setFont(new Font("Courier", Font.BOLD, 17));
